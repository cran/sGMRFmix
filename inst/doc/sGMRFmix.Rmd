...
Optimal `rho` value that has the best performance to detect the anomalies is 1.29.
...
In reality, true structures are unknown. 
We should check estimated structures and consider whether it is reasonable.
